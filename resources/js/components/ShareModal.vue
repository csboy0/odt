<template>
  <div>
    ...
    >
      ...
      />
      <div
      class=" w-full text-center mt-5 border-y-2 border-slate-300  flex">
      <h1 class="mb-0 cursor-pointer select-choice flex-1 py-2 text-lg bg-slate-300">Share File</h1>
      <h1 class="mb-0 cursor-pointer flex-1 py-2 text-lg ">Create Link</h1>
